...
-- Started on 2016-04-12 00:58:23
...
COPY "Category" ("UserId", "CategoryId") FROM stdin;
\.
...
COPY "CategoryStatement" ("CategoryId", "StatementId") FROM stdin;
\.
...
COPY "Rating" ("UserId", "StatementId") FROM stdin;
\.
...
COPY "Reference" ("ReferenceId", "UserId") FROM stdin;
\.
...
COPY "Referencing" ("ReferencingId", "ReferenceId", "StatementId", "UserId") FROM stdin;
\.
...
COPY "Statement" ("StatementId", "UserId") FROM stdin;
\.
...
COPY "StatementTag" ("StatementId", "UserId", "TagId") FROM stdin;
\.
...
COPY "User" ("UserId", "OtherName", "LastName", "EmailAddress", "Password", "Created", "Title", "DateOfBirth", "Role", "Username", "FirstName", "PostNominal") FROM stdin;
1	Ian Andrew                                                                                          	McLeod                                            	l.mcleod95@gmail.com	$2a$08$MwlH29hddk6aOW0HxVe1beB1H4cT5OWGfemoc/yHdcijYDUgzVJQC	2016-04-01	Mr   	1995-02-18	admin	LiamMcLeod	Liam                                              	\N
2	None                                                                                                	Toor                                              	root@localhost	$2a$08$DDxqS.00MfkQyIRLRYN4qObROja5Q2P3IyCoSV2SLO0NsfDyDeD82	2016-04-07	Dr   	1995-02-18	admin	root	Root                                              	\N
\.
...
COPY "Voting" ("VotingId", "UserId", "ReferencingId") FROM stdin;
\.
...
-- Completed on 2016-04-12 00:58:33
